      ...
      <Host>
        ...
        <div class=" my-10">
          ...
          <div class="my-3 leading-7">
            Manage Permission component is used by the owner of the service & admin to manage the
            permission regarding the services. Any service can have the three levels of
            permissions:-
            <ul class="list-disc">

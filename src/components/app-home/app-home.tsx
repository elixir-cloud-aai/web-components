      ...
      <Host>
        <div class="relative">
          <div class="absolute right-10 md:right-40 -top-28 -z-10">
            <img
              src="https://raw.githubusercontent.com/elixir-cloud-aai/logo/dev/logo.svg"
              class="inline-block mx-3 opacity-20 w-96 md:w-108"
            ></img>
          </div>
          <div class="mx-10 md:ml-40 mt-28 mb-40 md:mb-56 md:mr-40 lg:mr-108 md:mt-40 static">
            <div class="text-4xl font-bold md:text-5xl text-gray-700">
              Build service dashboards rapidly with{" "}
              <span class="text-primary font-extrabold">Elixir Cloud Components</span>.
            </div>
            <br></br>
            <div class="text-xl text-gray-400">
              These provide you with the various lightweight, fast, reusable Web Components to be
              use in your application enviroment independently.
            </div>
            <button
          ...
          <div class="mx-10 my-10 md:mx-40">
            <div class="flex flex-col lg:flex-row">
              ...
              <div class="text-lg md:text-xl text-gray-700 flex-1 mt-5 lg:mt-0">
                ...
                . ELIXIR Cloud & AAI is a cross platform initiative of ELIXIR and a driver project
                of the Global Alliance for Genomics and Health better known as{" "}
                <span class="font-semibold text-primary hover:border-primary border-b-2 border-white transition ease-out duration-500">
            ...
            <div class="flex flex-col lg:flex-row">
              ...
              <div class="text-lg md:text-xl text-gray-700 flex-1 mt-5 lg:mt-0">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 inline mb-3 pt-2 mr-2 text-secondary"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >

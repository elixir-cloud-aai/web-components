      ...
      <Host>
        ...
        <div class=" my-10">
          ...
          <div class="my-3 leading-7">
            Service list component list out all the service's avaliable to the user. All the
            services shown to the user can be classified into three main categories:-
            <ul class="mt-1">
